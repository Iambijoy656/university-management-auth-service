...
const createSemester = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield academicSemeter_model_1.AcademicSemester.create(payload);
    return result;
});
const getAllSemester = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield academicSemeter_model_1.AcademicSemester.find(whereCondition)
        .sort(sortCondition)
        .skip(skip)
        .limit(limit);
    const total = yield academicSemeter_model_1.AcademicSemester.countDocuments(whereCondition);
    return {
        meta: {
            page,
            limit,
...
const updateSemester = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield academicSemeter_model_1.AcademicSemester.findOneAndUpdate({ _id: id }, payload, {
        new: true,
    });
    return result;
});
const deleteSemester = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield academicSemeter_model_1.AcademicSemester.findByIdAndDelete(id);
    return result;
});
